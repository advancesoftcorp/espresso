...
#if defined(__MPI)
#if defined (_WIN32)
  ALLOCATE(gf_buf(LBOUND(gf,1):UBOUND(gf,1), LBOUND(gf,2):UBOUND(gf,2), LBOUND(gf,3):UBOUND(gf,3)))
  gf_buf = gf
  CALL MPI_ALLREDUCE(gf_buf,gf,3*nat*3*nat*el_ph_nsigma, &
