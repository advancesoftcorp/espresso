...
#if defined (_WIN32)
       REAL(DP), ALLOCATABLE :: lambda_repl_buf(:,:)
#endif
       lambda_repl = 0.0d0
       IF( idesc(LAX_DESC_ACTIVE_NODE) > 0 ) THEN
          ir = idesc(LAX_DESC_IR)
...
#if defined __MPI
#if defined (_WIN32)
       ALLOCATE(lambda_repl_buf(LBOUND(lambda_repl,1):UBOUND(lambda_repl,1), &
                                LBOUND(lambda_repl,2):UBOUND(lambda_repl,2)))
       lambda_repl_buf = lambda_repl
       CALL MPI_ALLREDUCE( lambda_repl_buf, lambda_repl, SIZE(lambda_repl), MPI_DOUBLE_PRECISION, &
                           MPI_SUM, ortho_parent_comm, ierr )
       DEALLOCATE(lambda_repl_buf)
#else
...
#if defined (_WIN32)
       REAL(DP), ALLOCATABLE :: zmat_repl_buf(:,:)
#endif
       zmat_repl = 0.0d0
...
#if defined __MPI
#if defined (_WIN32)
       ALLOCATE(zmat_repl_buf(LBOUND(zmat_repl,1):UBOUND(zmat_repl,1), &
                              LBOUND(zmat_repl,2):UBOUND(zmat_repl,2)))
       zmat_repl_buf = zmat_repl
       CALL MPI_ALLREDUCE( zmat_repl_buf, zmat_repl, SIZE(zmat_repl), MPI_DOUBLE_PRECISION, &
                           MPI_SUM, ortho_parent_comm, ierr )
       DEALLOCATE(zmat_repl_buf)
#else
