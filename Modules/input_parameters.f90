...
!
        ...
        REAL(DP) :: zmp_mixing = 1.0_DP ! mixing rate of charge density of ZMP.
        ...
        NAMELIST / control / title, calculation, verbosity, restart_mode, &
          ...
          tzmp, zmp_file, zmp_mixing, vdw_table_name, lorbm, memory,      &
...
!=----------------------------------------------------------------------------=!
        ...
        CHARACTER(len=80) :: diagonalization = 'david'
          ! diagonalization = 'david', 'cg', 'ppcg' or 'rmm'
