...
MODULE qes_init_module
  ...
  !
  !
  SUBROUTINE qes_init_solvent(obj, tagname, molec_file, density1, density2)
    !
    IMPLICIT NONE
    !
  ...
  !
  !
  SUBROUTINE qes_init_rism3d(obj, tagname, nmol, solvents, ecutsolv, molec_dir)
    !
    IMPLICIT NONE
    !
    ...
    TYPE(solvent_type), DIMENSION(:), INTENT(IN)  :: solvents
    ...
    obj%nmol = nmol
    !
    ALLOCATE(obj%solvents(SIZE(solvents)))
    obj%ndim_solvents = SIZE(solvents)
  ...
  !
  !
  SUBROUTINE qes_init_rismlaue(obj, tagname, both_hands, nfit, pot_ref, charge, &
