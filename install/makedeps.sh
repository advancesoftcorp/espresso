...
then
    dirs=" LAXlib FFTXlib UtilXlib upflib Modules clib LR_Modules \
           ...
           KS_Solvers/ParO KS_Solvers/RMM KS_Solvers/DENSE  \
...
for dir in $dirs; do
	...
	atomic/src | GWW/gww )
	     DEPENDS="$DEPEND2" ;;
	PW/src | CPV/src )
	     DEPENDS="$DEPEND2 ../../KS_Solvers/Davidson ../../KS_Solvers/CG ../../KS_Solvers/PPCG ../../KS_Solvers/ParO ../../KS_Solvers/RMM ../../KS_Solvers/DENSE ../../dft-d3" ;;
	KS_Solvers/Davidson | KS_Solvers/Davidson_RCI | KS_Solvers/CG | KS_Solvers/PPCG | KS_Solvers/ParO | KS_Solvers/RMM | KS_Solvers/DENSE )
	     DEPENDS="$DEPEND3" ;;
